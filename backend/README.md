...
## Project Structure
    ...
    ├── testapiautoconnect_112787  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_112787`
...
2. Clone this repo and `cd testapiautoconnect_112787`
